    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                Thread.sleep(2000);
                return WebserviceConnectionController.getInstance().isValidUser(new User(mPassword,mEmail));
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
               WebserviceConnectionController.getInstance().setUser(new User(mPassword,mEmail));
